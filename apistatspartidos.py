...
#Llama directamente a la API utilizando los códigos de partido del json que trae apipartido.
#Parsea los datos traidos por el JSON de la API a nuestros propios parametros de datos y lo exporta a mongo 
...
def load_fixture_ids():
    ...
    with open("C:/Users/Daniela/Desktop/SEMESTRE 2/Proyecto Progra 2/partidos.json", 'r', encoding='utf-8') as file:
        data = json.load(file)
